...
export default function Smallpeople({navigation}) {
  return (
    <View style={styles.container}>
     ...
     <Image source={require('../assets/pics/smallpeople.png')} style={styles.people}/>
     </View>
     <View style={{height:10}}/>
     <View style={styles.smallpeople}>
     <Image source={require('../assets/pics/smallscaleorders.png')} style={styles.people}/>
     </View>
