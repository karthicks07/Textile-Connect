  ...
  return (
    <View style={styles.container}>
     ...
     <Image source={require('../assets/pics/arrow.png')} style={styles.frontimg}/>
      ...
      <Text style={{fontSize:24, color:'#0A2ACF'}}>LargeScale</Text>
      ...
      <View style={styles.peopleview}>
        <TouchableOpacity onPress={()=> navigation.navigate('Largepeople')}>
      <Image source={require('../assets/pics/largeindus.png')} style={styles.pic}/>
      </TouchableOpacity>
      <Image source={require('../assets/pics/largeindus.png')} style={styles.pic}/>
